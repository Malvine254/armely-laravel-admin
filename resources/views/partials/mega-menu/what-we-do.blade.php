    ...
    <div class="mega-columns">
        ...
        <div>
            ...
            <ul class="mega-link-list">
                ...
                <li><a class="mega-link-with-icon" href="{{ route('services.show', ['name' => 'sql-server']) }}"><span class="mega-link-icon"><i class="fa-solid fa-server" aria-hidden="true"></i></span><span class="mega-link-copy"><span class="mega-link-label">SQL Server</span><span class="mega-link-description">Reliable data and warehouse foundations.</span></span></a></li>
