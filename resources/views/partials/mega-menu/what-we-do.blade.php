    ...
    <div class="mega-columns">
        <div>
            ...
            <ul class="mega-link-list">
                ...
                <li><a class="mega-link-with-icon" href="{{ route('services.show', ['name' => 'fractional-dba']) }}"><span class="mega-link-icon"><i class="fa-solid fa-database" aria-hidden="true"></i></span><span class="mega-link-copy"><span class="mega-link-label">Fractional DBA</span><span class="mega-link-description">On-demand senior database leadership for SQL Server, Azure SQL, and Snowflake.</span></span></a></li>
