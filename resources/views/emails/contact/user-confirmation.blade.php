...
<head>
    ...
    <title>Thank you for contacting Armely</title>
</head>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #d6e1f7;">
                <tr>
                    <td style="background:linear-gradient(135deg,#153462 0%,#2f5597 100%);padding:28px 30px;">
                        <p style="margin:0;color:#9cc8ff;font-size:12px;letter-spacing:1.2px;text-transform:uppercase;font-weight:700;">Armely Contact Desk</p>
                        <h1 style="margin:10px 0 0;color:#ffffff;font-size:24px;line-height:1.2;">We Received Your Message</h1>
                    </td>
                </tr>
                <tr>
                    <td style="padding:28px 30px 20px;">
                        <p style="margin:0 0 14px;font-size:16px;line-height:1.6;">Dear {{ e($name) }},</p>
                        <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#324a73;">Thank you for contacting Armely. We have received your inquiry and our team will get back to you shortly.</p>
                        ...
                        <p style="margin:16px 0 0;font-size:14px;line-height:1.7;color:#4f6690;">If you need to share more details, simply reply to this email.</p>
