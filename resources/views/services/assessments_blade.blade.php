...
@section('title', 'Armely - Assessments')
...
@section('canonical_url', url('/service-details/assessments'))
...
.section-title { font-size:clamp(1.4rem,2.6vw,2rem); font-weight:800; color:#1a2540; line-height:1.15; letter-spacing:-0.02em; margin-bottom:10px; text-align:center; max-width:820px; margin-left:auto; margin-right:auto; }
