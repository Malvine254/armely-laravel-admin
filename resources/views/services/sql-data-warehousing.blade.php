    ...
    <div class="intro-grid">
      <div>
        ...
        <div class="cap-grid">
          ...
          <div class="cap-pill"><span class="cap-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 8V4H8"/><rect x="3" y="8" width="18" height="12" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M9 11v2"/><path d="M15 11v2"/></svg></span><span class="cap-label">Cortex AI & LLM Functions</span></div>
          <div class="cap-pill"><span class="cap-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M6 18h8"/><path d="M3 22h18"/><path d="M14 22a7 7 0 1 0 0-14h-1"/><path d="M9 14h2"/><path d="M9 12a2 2 0 0 1-2-2V6h6v4a2 2 0 0 1-2 2Z"/><path d="M12 6V3a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3"/></svg></span><span class="cap-label">Data Science & Snowpark</span></div>
          <div class="cap-pill"><span class="cap-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg></span><span class="cap-label">Data Sharing & Marketplace</span></div>
          <div class="cap-pill"><span class="cap-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M13 2 3 14h9l-1 8 11-14h-9l1-6Z"/></svg></span><span class="cap-label">Real-Time & Streaming</span></div>
          <div class="cap-pill"><span class="cap-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z"/><path d="m9 12 2 2 4-4"/></svg></span><span class="cap-label">Horizon Governance</span></div>
        </div>
        <div class="vs-callout">
          <span class="vs-callout-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></svg></span>
  ...
  <div class="section-inner">
    ...
    <div class="delivers-grid">
      ...
      <div class="deliver-card">
        ...
        <div class="deliver-title">Data modeling & Transformation</div>
      ...
      <div class="deliver-card">
        ...
        <div class="deliver-desc">Horizon governance, dynamic data masking, row-level access policies, and cost monitoring, configured from the start. Plus a dedicated Armely contact for ongoing optimization and support.</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="section-inner">
    ...
    <div class="steps-row">
      ...
      <div class="step">
        ...
        <div class="step-desc">Cost optimization, performance tuning, new workload onboarding, and a single Armely contact as your Snowflake environment grows.</div>
  ...
  <div class="section-inner">
    ...
    <div class="uc-grid">
      <div class="uc-card">
        ...
        <div class="uc-title">Data Warehouse modernization</div>
      ...
      <div class="uc-card">
        <span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="m11 17 2 2a1 1 0 1 0 3-3"/><path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4"/><path d="m21 3 1 11h-1"/><path d="M3 3 2 14l6.5 6.5a1 1 0 1 0 3-3"/><path d="M3 4h8"/></svg></span>
      ...
      <div class="uc-card">
        <span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M13 2 3 14h9l-1 8 11-14h-9l1-6Z"/></svg></span>
      ...
      <div>
        ...
        <ul class="why-list">
          ...
          <li>
            ...
            <div>
              <div class="why-item-title">Cost Optimization From Day One</div>
      ...
      <div>
        <div class="partner-block">
          <div class="partner-block-top">
            <div class="partner-label">Snowflake Authorized Partner</div>
          ...
          <div class="partner-stats">
            <div class="p-stat">
              ...
              <div class="p-stat-label">organizations running Snowflake globally</div>
            </div>
            <div class="p-stat">
...
<footer>
  ...
  <div class="footer-badges">
    <span class="badge-chip">Snowflake Partner</span>
    <span class="badge-chip">Microsoft CSP Partner</span>
    <span class="badge-chip">Data Cloud Certified</span>
  </div>
</footer>
