...
.armely-sql-server-page .cr-card { background:#fff; border:1px solid var(--border); border-radius:12px; padding:20px 22px; box-shadow:0 2px 10px rgba(18,47,82,0.04); }
...
.armely-sql-server-page .cr-industry { font-size:0.875rem; font-weight:700; color:#1A2540; }
.armely-sql-server-page .cr-desc { font-size:0.82rem; color:var(--text-muted); line-height:1.65; margin:0; }
.armely-sql-server-page .cr-cta { text-align:center; }
.armely-sql-server-page .cr-btn { display:inline-flex; align-items:center; gap:10px; background:#1a2e52; color:#fff; border-radius:8px; padding:12px 28px; text-decoration:none; font-size:0.875rem; font-weight:600; }
...
<section class="hero">
  ...
  <div class="hero-inner">
    <div class="hero-copy">
      <div class="hero-eyebrow"><span class="eyebrow-badge">Microsoft SQL Server</span><span class="eyebrow-partner">Delivered by a certified Microsoft partner</span></div>
...
<section class="usecases"><div class="section-inner"><div class="section-eyebrow">Common Engagements</div><h2 class="section-title">The SQL Server situations we resolve most often.</h2><p class="section-body">These are the scenarios organizations bring to Armely. Each one has a clear resolution path with a defined outcome.</p>
<div class="uc-grid"><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg></span><div class="uc-title">SQL Server to Azure Migration</div><div class="uc-desc">Migrate from an aging on-premises SQL Server to Azure SQL Database or Managed Instance, with compatibility assessment, data migration, and cutover planning.</div></div><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg></span><div class="uc-title">Slow Query and Performance Issues</div><div class="uc-desc">Identify and resolve performance problems caused by missing indexes, parameter sniffing, stale statistics, blocking, or hardware misconfiguration.</div></div><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z"/><path d="m9 12 2 2 4-4"/></svg></span><div class="uc-title">Security and Compliance Audit</div><div class="uc-desc">SQL Server environments that have grown without formal security review often have overprivileged logins and no audit trail. We assess and remediate to a documented baseline.</div></div><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0 0 18 0V5"/><path d="M3 12a9 3 0 0 0 18 0"/></svg></span><div class="uc-title">High Availability Implementation</div><div class="uc-desc">Implement Always On Availability Groups or Azure-native high availability for databases where downtime is not acceptable.</div></div><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg></span><div class="uc-title">Version Upgrade</div><div class="uc-desc">Upgrade from SQL Server 2012, 2014, or 2016 to SQL Server 2022 or Azure SQL, capturing security, performance, and licensing benefits.</div></div><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg></span><div class="uc-title">Ongoing DBA Services</div><div class="uc-desc">Organizations without a dedicated DBA use Armely for patch management, backup verification, capacity planning, index maintenance, and on-call support.</div></div></div></div></section>
