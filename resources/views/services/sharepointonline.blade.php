...
.armely-sharepoint-page .hero h1 { font-size: clamp(1.75rem, 3.2vw, 2.7rem); font-weight: 800; line-height: 1.08; color: #FFFFFF; max-width: 820px; margin-bottom: 24px; letter-spacing: -0.03em; }
...
@media (max-width: 600px) {
  .armely-sharepoint-page .hero h1 { font-size: clamp(1.75rem, 3.2vw, 2.7rem); }
...
.armely-sharepoint-page .cr-card { background:#fff; border:1px solid var(--border); border-radius:14px; padding:22px; box-shadow:0 14px 36px rgba(18,47,82,0.08); }
...
.armely-sharepoint-page .cr-industry { font-size:0.875rem; font-weight:700; color:#162b49; }
.armely-sharepoint-page .cr-desc { font-size:0.84rem; color:var(--text-muted); line-height:1.65; margin:0; }
.armely-sharepoint-page .cr-cta { text-align:center; margin-top:8px; }
.armely-sharepoint-page .cr-btn { display:inline-flex; align-items:center; gap:10px; background:#1a2e52; color:#fff; border-radius:8px; padding:13px 28px; text-decoration:none; font-size:0.875rem; font-weight:600; }
