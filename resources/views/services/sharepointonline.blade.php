...
@section('title', 'Armely - Microsoft SharePoint')
@section('meta_description', 'SharePoint implementation, intranet, document management, migration, governance, Teams and Power Platform integration services from Armely.')
@section('meta_keywords', 'SharePoint, Microsoft SharePoint, intranet, document management, SharePoint migration, Armely')
@section('canonical_url', url('/service-details/sharepoint'))

@push('head')
<meta property="og:title" content="Armely - Microsoft SharePoint">
<meta property="og:description" content="SharePoint implementation, intranet, document management, migration, governance, Teams and Power Platform integration services from Armely.">
<meta property="og:url" content="{{ url('/service-details/sharepoint') }}">
<meta name="twitter:title" content="Armely - Microsoft SharePoint">
<meta name="twitter:description" content="SharePoint implementation, intranet, document management, migration, governance, Teams and Power Platform integration services from Armely.">
@endpush
...
.armely-sharepoint-page { --navy:      #FFFFFF;
    --navy-mid:  #F3F6FB;
    --navy-card: #EBF0F8;
    --blue:      #294e8b;
    --blue-lt:   #3d6ab5;
...
.armely-sharepoint-page * { transition: none !important; animation: none !important; }
}
