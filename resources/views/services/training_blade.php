...
.armely-training-page .hero h1 { font-size: clamp(2.6rem, 5.5vw, 4.8rem); font-weight: 800; line-height: 1.08; color: #FFFFFF; max-width: 820px; margin-bottom: 24px; letter-spacing: -0.03em; }
.armely-training-page .hero h1 .hl { color: #FFFFFF; opacity: 0.92; }
.armely-training-page .hero-sub { font-size: 1.05rem; font-weight: 300; color: rgba(255,255,255,0.82); max-width: 580px; margin-bottom: 40px; line-height: 1.8; }
...
@media (max-width: 600px) {
  .armely-training-page .hero h1 { font-size: clamp(2.15rem, 11vw, 3.2rem) !important; }
