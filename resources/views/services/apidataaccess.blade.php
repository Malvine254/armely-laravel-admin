...
.armely-api-development-page .hero h1 { font-size: clamp(1.75rem, 3.2vw, 2.7rem); font-weight: 800; line-height: 1.08; color: #FFFFFF; max-width: 820px; margin-bottom: 24px; letter-spacing: -0.03em; }
...
@media (max-width: 600px) {
  .armely-api-development-page .hero h1 { font-size: clamp(1.75rem, 3.2vw, 2.7rem); }
...
.armely-api-development-page .cr-card { background:#fff; border:1px solid var(--border); border-radius:14px; padding:22px; box-shadow:0 14px 36px rgba(18,47,82,0.08); }
...
.armely-api-development-page .cr-industry { font-size:0.875rem; font-weight:700; color:#162b49; }
.armely-api-development-page .cr-desc { font-size:0.84rem; color:var(--text-muted); line-height:1.65; margin:0; }
.armely-api-development-page .cr-cta { text-align:center; margin-top:8px; }
.armely-api-development-page .cr-btn { display:inline-flex; align-items:center; gap:10px; background:#1a2e52; color:#fff; border-radius:8px; padding:13px 28px; text-decoration:none; font-size:0.875rem; font-weight:600; }
  ...
  <div class="hero-inner">
    <div class="hero-copy">
      <div class="hero-eyebrow">
        <span class="eyebrow-badge">Integration and API Development</span>
...
<section class="cta-section" id="contact"><div class="cta-inner"><div><div class="section-eyebrow">Get Started</div><h2 class="section-title">Tell us the integration problem. We will design the API.</h2><p class="section-body">Book a free 30-minute discovery call. We will review your integration requirements and come back with an API architecture recommendation.</p><div style="margin-top:28px;display:flex;flex-direction:column;gap:12px;"><div class="trust-item"><span class="trust-dot" style="background:var(--blue);"></span><span class="trust-text" style="color:var(--text-body);">Free assessment, no commitment required</span></div><div class="trust-item"><span class="trust-dot" style="background:var(--blue);"></span><span class="trust-text" style="color:var(--text-body);">Recommendation and partner pricing included</span></div><div class="trust-item"><span class="trust-dot" style="background:var(--blue);"></span><span class="trust-text" style="color:var(--text-body);">Response within one business day</span></div></div></div>@include('partials.service-contact-form', [
      'serviceContact' => [
        ...
        'options' => [
            ...
            'Build a new API for internal or external consumers',
            'Expose our data securely to a third party',
            'Build the API layer for an AI agent',
            'Modernize or document an existing API',
