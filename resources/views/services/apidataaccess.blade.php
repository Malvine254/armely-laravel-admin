...
@section('title', 'Armely - API Development and Integration')
@section('meta_description', 'API development, system integration, automation, middleware, secure endpoints, and Azure API Management services from Armely.')
@section('meta_keywords', 'API development, API integration, system integration, middleware, Azure API Management, Armely')
@section('canonical_url', url('/service-details/api-development'))

@push('head')
<meta property="og:title" content="Armely - API Development and Integration">
<meta property="og:description" content="API development, system integration, automation, middleware, secure endpoints, and Azure API Management services from Armely.">
<meta property="og:url" content="{{ url('/service-details/api-development') }}">
<meta name="twitter:title" content="Armely - API Development and Integration">
<meta name="twitter:description" content="API development, system integration, automation, middleware, secure endpoints, and Azure API Management services from Armely.">
@endpush
...
.armely-api-development-page { --navy:      #FFFFFF;
    --navy-mid:  #F3F6FB;
    --navy-card: #EBF0F8;
    --blue:      #294e8b;
    --blue-lt:   #3d6ab5;
...
.armely-api-development-page * { transition: none !important; animation: none !important; }
}
