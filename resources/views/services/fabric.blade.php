...
.armely-fabric-page .hero h1 { font-size: clamp(1.75rem, 3.2vw, 2.7rem); font-weight: 800; line-height: 1.08; color: #FFFFFF; max-width: 820px; margin-bottom: 24px; letter-spacing: -0.03em; }
...
@media (max-width: 600px) {
  .armely-fabric-page .hero h1 { font-size: clamp(1.75rem, 3.2vw, 2.7rem); }
...
.armely-fabric-page .cr-card { background:#fff; border:1px solid var(--border); border-radius:14px; padding:22px; box-shadow:0 14px 36px rgba(18,47,82,0.08); }
...
.armely-fabric-page .cr-industry { font-size:0.875rem; font-weight:700; color:#162b49; }
.armely-fabric-page .cr-desc { font-size:0.84rem; color:var(--text-muted); line-height:1.65; margin:0; }
.armely-fabric-page .cr-cta { text-align:center; margin-top:8px; }
.armely-fabric-page .cr-btn { display:inline-flex; align-items:center; gap:10px; background:#1a2e52; color:#fff; border-radius:8px; padding:13px 28px; text-decoration:none; font-size:0.875rem; font-weight:600; }
...
<section class="usecases"><div class="section-inner"><div class="section-eyebrow">Common Engagements</div><h2 class="section-title">Real answers to real business questions.</h2><p class="section-body">Fabric is the foundation for every business decision your team makes.</p>
<div class="uc-grid"><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><line x1="18" x2="18" y1="20" y2="10"/><line x1="12" x2="12" y1="20" y2="4"/><line x1="6" x2="6" y1="20" y2="14"/></svg></span><div class="uc-title">Executive Dashboards</div><div class="uc-desc">Live KPI dashboards that pull from every system into a single view. Leadership sees the truth, not last week's export.</div></div><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></span><div class="uc-title">Financial Reporting</div><div class="uc-desc">Automate month-end reporting, budget versus actual analysis, and cost center breakdowns.</div></div><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg></span><div class="uc-title">Operational Intelligence</div><div class="uc-desc">Track productivity, resource utilization, and service delivery in real time.</div></div><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg></span><div class="uc-title">System Consolidation</div><div class="uc-desc">Connect ERP, CRM, HR, and third-party data into one governed data layer.</div></div><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg></span><div class="uc-title">Predictive Analytics</div><div class="uc-desc">Build models that forecast demand, flag churn risk, or surface patterns in your historical data.</div></div><div class="uc-card"><span class="uc-icon"><svg class="icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4z"/></svg></span><div class="uc-title">Natural Language Queries</div><div class="uc-desc">With Copilot embedded in Fabric, anyone on your team can ask questions in plain English.</div></div></div></div></section>
