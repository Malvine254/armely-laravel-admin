...
@section('title', 'Armely - Custom Application and Web Development')
@section('meta_description', 'Custom web applications, portals, workflow systems, dashboards, APIs, and cloud-ready software development services from Armely.')
@section('meta_keywords', 'custom application development, web development, portals, dashboards, Laravel, React, Armely')
@section('canonical_url', url('/service-details/custom-development'))

@push('head')
<meta property="og:title" content="Armely - Custom Application and Web Development">
<meta property="og:description" content="Custom web applications, portals, workflow systems, dashboards, APIs, and cloud-ready software development services from Armely.">
<meta property="og:url" content="{{ url('/service-details/custom-development') }}">
<meta name="twitter:title" content="Armely - Custom Application and Web Development">
<meta name="twitter:description" content="Custom web applications, portals, workflow systems, dashboards, APIs, and cloud-ready software development services from Armely.">
@endpush
...
.armely-custom-development-page { --navy:      #FFFFFF;
    --navy-mid:  #F3F6FB;
    --navy-card: #EBF0F8;
    --blue:      #294e8b;
    --blue-lt:   #3d6ab5;
...
.armely-custom-development-page * { transition: none !important; animation: none !important; }
}
...
<a class="btn-primary" href="#contact">Book a Free Discovery Call</a>
