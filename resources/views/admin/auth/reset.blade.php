...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .auth-footer p, .hint { color: var(--muted); font-size: 13px; margin: 0; line-height: 1.55; }
        ...
        <section class="auth-card">
            ...
            <form method="POST" action="{{ route('admin.reset.post') }}">
                ...
                <div class="form-group">
                    ...
                    <p class="hint mt-2"><i class="fas fa-info-circle me-1"></i>We will send a secure reset link if this admin account exists.</p>
                </div>

                <button type="submit" class="btn btn-auth"><i class="fas fa-paper-plane me-2"></i>Send Reset Link</button>
            </form>
