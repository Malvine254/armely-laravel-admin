...
.partner-hero {
    background: linear-gradient(135deg, #1a1f36 0%, #ee0000 55%, #c90000 100%);
    color: #fff;
    padding: 80px 0;
    position: relative;
    overflow: hidden;
...
<section class="partner-hero">
    <div class="hero-inner">
        <div class="hero-grid">
            <div>
                <h1 class="hero-title">Build Open. Run Anywhere. Innovate Everywhere.</h1>
                <p class="hero-sub">As a Red Hat Premier Business PartnerRed Hat's highest level of partnershipwe deliver enterprise-grade open-source solutions built for scale, performance, and hybrid cloud innovation. From Kubernetes platforms to automation and cloud-native development, we help organizations unlock the full value of their IT investments.</p>
                <div class="hero-ctas">
                    <a class="hero-cta" href="#openshift">OpenShift</a>
                    <a class="hero-cta" href="#ansible">Ansible Automation</a>
                    <a class="hero-cta" href="/contact">Start Building</a>
                </div>
            </div>
            <div class="text-center">
                <img class="hero-logo" alt="Red Hat Logo" src="/images/partners/redhat.jpg">
            </div>
        </div>
    </div>
</section>
