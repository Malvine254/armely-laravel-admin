...
export const useAuthStore = defineStore('auth', () => {
  ...
  const isManager = computed(() => {
    return isAuthenticated.value && (user.value?.role === 'manager' || user.value?.role === 'admin')
  })
  ...
  const hasFeatureAccess = (feature) => {
    ...
    const featureRoles = {
      'quotes': ['user', 'buyer', 'owner', 'manager', 'admin'],
      'orders': ['user', 'buyer', 'owner', 'manager', 'admin'],
      'invoices': ['user', 'buyer', 'owner', 'manager', 'admin'],
      'messages': ['user', 'buyer', 'owner', 'manager', 'admin'],
      'admin': ['admin'],
