      ...
      <div class="bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <button
            type="submit"
            :disabled="!canSubmit"
            class="w-full px-6 py-3 text-white font-semibold rounded-lg transition transform hover:scale-105 active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none"
