      ...
      <div v-if="product && relatedProducts.length > 0" class="mt-6 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden p-6 lg:p-8">
        ...
        <div class="grid grid-cols-1 gap-4 xl:grid-cols-2">
          <div v-for="relatedProduct in paginatedRelated" :key="relatedProduct.productId"
               class="group flex min-h-[248px] flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-[0_2px_10px_rgba(15,42,82,0.05)] transition hover:border-blue-200 hover:shadow-[0_8px_24px_rgba(15,42,82,0.10)] sm:h-[300px] sm:min-h-0 sm:flex-row">
            <!-- Product Image -->
