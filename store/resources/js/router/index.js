...
router.beforeEach((to, from, next) => {
  ...
  if (authStore.isActivationPending) {
    const allowedNames = ['home', 'products', 'products-filter', 'product-detail', 'cart', 'favorites', 'account', 'activate-account', 'login', 'privacy', 'cookie-settings'];
  ...
  if (authStore.isRestricted) {
    const allowedNames = ['home', 'products', 'products-filter', 'product-detail', 'cart', 'favorites', 'account', 'login', 'privacy', 'cookie-settings'];
    if (to.name && !allowedNames.includes(to.name)) {
      const toastStore = useToastStore();
