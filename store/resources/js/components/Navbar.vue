<template>
  <nav class="sticky top-0 z-[100] isolate overflow-x-clip bg-white shadow-[0_4px_18px_rgba(15,42,82,0.10)]">
    <!-- Utility bar -->
    <div v-if="showUtilityBar" class="hidden text-white lg:block" style="background: linear-gradient(to right, #183a72, #0f2a54);">
    ...
    <div class="w-full px-3 sm:px-4 lg:px-5">
      <div class="flex min-h-20 w-full flex-wrap items-center justify-between gap-x-2 py-3 lg:min-h-24 lg:justify-center lg:gap-x-4 2xl:gap-x-7">
        ...
        <div class="order-4 -mx-3 mt-3 hidden min-h-14 w-[calc(100%+1.5rem)] flex-none items-stretch justify-center sm:-mx-4 sm:w-[calc(100%+2rem)] lg:-mx-5 lg:w-[calc(100%+2.5rem)] xl:flex" style="background: linear-gradient(to right, #183a72, #0f2a54);">
          ...
          >
            ...
            <transition enter-active-class="transition ease-out duration-150" enter-from-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1">
              <div v-if="categoryDropdownOpen === cat.value" class="absolute left-0 top-full z-[150] mt-1 w-80 overflow-x-hidden rounded-xl border border-white/20 shadow-2xl whitespace-normal" style="background: #0f2a54;">
          ...
          <div v-if="overflowCategories.length > 0" class="relative flex min-w-0 flex-1 items-center" @mouseenter="moreCategoriesOpen = true" @mouseleave="moreCategoriesOpen = false">
            ...
            <transition enter-active-class="transition ease-out duration-150" enter-from-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1">
              <div v-if="moreCategoriesOpen" class="absolute right-0 top-full z-[150] mt-1 w-[42rem] max-w-[calc(100vw-2rem)] rounded-xl shadow-2xl overflow-hidden border border-white/20 whitespace-normal" style="background: #0f2a54;">
                <div class="px-4 py-2.5 border-b border-white/20">
      ...
      <div v-if="mobileMenuOpen" class="xl:hidden pb-4">
        <div class="rounded-lg border border-white/20 overflow-hidden" style="background: #0f2a54;">
          ...
          <div class="border-b border-white/10">
            ...
            <div v-if="mobileProductsOpen" style="background: #0f2a54;">
